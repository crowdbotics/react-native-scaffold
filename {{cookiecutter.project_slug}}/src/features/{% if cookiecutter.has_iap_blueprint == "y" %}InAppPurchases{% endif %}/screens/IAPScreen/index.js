...
import { View, Text, Alert, Platform, ScrollView, StyleSheet } from 'react-native';
import { Button } from "react-native-ui-kitten";
import RNIap, {
  Product, ProductPurchase, acknowledgePurchaseAndroid, purchaseUpdatedListener, purchaseErrorListener, PurchaseError,
...
export default class Page extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      availableItemsMessage: 'This is availableItemsMessage',
    };
  }
    ...
    return (
      <View style={ styles.container }>
        <View style={ styles.header }>
          <Text style={ styles.headerTxt} >In App Purchases</Text>
        </View>
